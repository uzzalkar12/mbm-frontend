    ...
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-toolbar">
        ...
        <div class="d-flex justify-content-end">
          ...
          <router-link :to="{name: 'productRequisitionsCreate'}" class="btn btn-sm btn-primary">
      ...
      <Datatable @on-sort="sort" :loading="loading" :data="product_requisitions" :header="tableHeader" :enable-items-per-page-dropdown="true">
        ...
        <template v-slot:actions="{ row: product_requisition }">
          <div class="flex flex-column">
            <router-link :to="{name:'productRequisitionsDetails', params:{ product_requisition_id: product_requisition.id }}" class="btn btn-sm btn-info me-2">
              <i class="bi bi-eye fs-4"></i> Details
            </router-link>
            <router-link :to="{name:'productRequisitionsUpdate', params:{ product_requisition_id: product_requisition.id }}" class="btn btn-sm btn-primary me-2">
              <i class="bi bi-pencil-square fs-4"></i> Update
            </router-link>
            <button title="Delete Product Requisition" class="btn btn-sm btn-danger" @click="deleteProductRequisition(product_requisition)">
